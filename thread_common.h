...
int delete_client(struct pollfd ** fds, char *** names, int * fds_size, int client_no);
void process_priority_request(struct pollfd * fds, int fds_size, char * room_name);
int transfer_client(int room_fd, struct pollfd ** fds, char *** names, int * fds_size, int client_no);
