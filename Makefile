...
SERVER_SRC=server.c accept.c comm.c menu.c proto.c signal.c thread_common.c users.c rooms.c
TEST_SRC=test.c accept.c comm.c menu.c proto.c signal.c thread_common.c users.c rooms.c
C_FLAGS=-Wall
LD_FLAGS=-pthread
CC=gcc
OBJ=$(SRC:.c=.o)
